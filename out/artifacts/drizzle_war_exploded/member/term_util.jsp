...
<div class="agree_fr text-start">
    ...
    본 약관은 (주)헤이에듀(이하 “회사”라 합니다)이 운영하는 웹사이트 ‘헤이에듀’(www.Grownjoy.com) (이하 “웹 사이트”라 합니다)에서 제공하는 온라인 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
