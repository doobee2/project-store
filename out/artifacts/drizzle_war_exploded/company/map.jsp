...
<head>
    ...
    <style>
        ...
        .text { margin-top:200px; block;}
        .map {  margin: 50px 10px; float:left; width: 50px; height: 50px; }
        .text >h2 { font-size: 40px; margin-bottom: 20px; }
        .text >p { font-size: 20px; margin: 5px; }
    </style>
</head>
<body>
...
<div class="container contents text-center">
    ...
    <div class="maparea">
        ...
        <script>
            ...
            marker.setMap(map);
            var iwContent = '<div style="padding:5px;">Hey Edu<br><a href="" style="color:blue;" target="_blank"></a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
        ...
        <div class="text">
            ...
            <a href="https://naver.me/FzQ6Ofpu"><img src="/assets/img/common/map1.png" alt="네이버지도 바로가기" class="map"></a>
            <a href="https://place.map.kakao.com/21160721"><img src="/assets/img/common/map2.png" alt="카카오맵 바로가기" class="map"></a>
            <a href="https://goo.gl/maps/HBSjHapKuPdRNFmg9"><img src="/assets/img/common/map3.png" alt="구글맵  바로가기" class="map"></a>
        </div>
